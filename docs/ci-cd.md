...
| Staging deploy fails on `Wait for backend healthcheck` (120 s) | Container stuck on migrations, env misconfig          | `ssh CryptoGanster 'docker logs onchain-bot-backend-staging --tail 100'`                          |
