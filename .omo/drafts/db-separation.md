...
- C1 | Ingestion: nueva DB por ambiente + baseline de migraciones + datos copiados | active | apps/ingestion-telegram/src/app.module.ts:59-81, src/telegram/crypto-news/.../entities/ (4 idénticas al backend)
...
- Droplet ingestion usa apps/ingestion-telegram/.env.production (NO existe en repo) + red onchain-bot-net → postgres prod.
