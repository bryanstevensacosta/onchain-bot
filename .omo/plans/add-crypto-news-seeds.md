# add-crypto-news-seeds - Work Plan
...
- Evidence: .omo/evidence/task-<N>-add-crypto-news-seeds.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-add-crypto-news-seeds.<ext>
