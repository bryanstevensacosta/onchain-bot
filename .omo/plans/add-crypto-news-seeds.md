...
- Evidence: .omo/evidence/task-<N>-add-feed-seeds.<ext>
...
- [ ] 1. <title>
     ...
     QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-add-feed-seeds.<ext>
