# cleanup-live-references-frontend - Work Plan
...
- [x] 4. Actualizar frontend AGENTS.md
  What to do / Must NOT do: Editar `apps/frontend/AGENTS.md` — eliminar la línea `- **Live route** — \`/live\` redirects to \`/tokens\`. No separate live page exists.`
  Parallelization: Wave 1 | Blocked by: — | Blocks: —
  References: `apps/frontend/AGENTS.md:106`
  Acceptance criteria (agent-executable): `grep -i "live route" apps/frontend/AGENTS.md` retorna exit code 1.
  QA scenarios:
