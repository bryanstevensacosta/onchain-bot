...
import { useTemplates } from '@/features/feed-publisher/model/use-llm-config';
import { useFeedSources } from '@/entities/feed';
import type {
  CreateKeywordBody,
  KeywordView,
  UpdateKeywordBody,
} from '@/features/feed-publisher/api/keywords-api';
import type { FeedSource } from '@/entities/feed';
import { SourceMultiSelect, templateLabel } from './source-multi-select';
import { CompoundGroupModal } from '@/features/feed-publisher/ui/compound-group-modal';
...
interface KeywordsModalProps {
  ...
  sourceOptions: readonly FeedSource[];
...
export function KeywordsSection(): React.ReactElement {
  ...
  function sourceDisplay(
    item: KeywordView,
    sourceOpts: readonly FeedSource[],
  ): string {
