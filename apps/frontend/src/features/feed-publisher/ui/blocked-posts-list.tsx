...
import { useQueue } from '@/features/feed-publisher/model/use-queue';
import type { QueueEntryView } from '@/features/feed-publisher/api/queue-api';
import { DetailsModal } from '@/features/feed-publisher/ui/queue-view';
