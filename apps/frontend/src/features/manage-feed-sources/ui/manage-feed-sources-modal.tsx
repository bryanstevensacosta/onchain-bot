...
import { useFeedSources } from '../model/use-feed-sources';
import { useAddFeedSource } from '../model/use-add-feed-source';
import { useUpdateFeedSource } from '../model/use-update-feed-source';
import { useDeleteFeedSource } from '../model/use-delete-feed-source';
import { useToggleFeedSource } from '../model/use-toggle-feed-source';

interface ManageFeedSourcesModalProps {
  isOpen: boolean;
  onClose: () => void;
}
...
export function ManageFeedSourcesModal({
  isOpen,
  onClose,
}: ManageFeedSourcesModalProps) {
