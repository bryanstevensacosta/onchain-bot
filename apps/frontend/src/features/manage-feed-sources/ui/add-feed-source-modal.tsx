...
interface AddFeedSourceModalProps {
  isOpen: boolean;
  onClose: () => void;
}
...
export function AddFeedSourceModal({
  isOpen,
  onClose,
}: AddFeedSourceModalProps) {
  const [channelId, setChannelId] = useState('');
  const [title, setTitle] = useState('');
  const mutation = useAddFeedSource();
