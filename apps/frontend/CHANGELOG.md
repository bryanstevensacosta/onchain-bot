...
v1.3.0 through v1.5.1) has been reset for version consistency across the monorepo.
...
consolidates all previous work (formerly tracked as v1.3.0 through v1.5.1) into
