 ...
 *
 * Recognized schemes: `https://…` → `https`, `http://…` → `http`,
 * `t.me/<user>` → `telegram`. Trailing punctuation is stripped by the
 * extractor adapter prior to construction.
 * Mirrors the backend `token/intake/extraction` url VO.
 */
