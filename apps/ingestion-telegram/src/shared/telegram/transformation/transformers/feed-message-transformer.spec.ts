import { FeedMessageTransformer } from './feed-message-transformer';

describe('FeedMessageTransformer', () => {
  let transformer: FeedMessageTransformer;

  beforeEach(() => {
    transformer = new FeedMessageTransformer();
  });
