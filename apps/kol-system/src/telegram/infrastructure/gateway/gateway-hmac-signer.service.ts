...
/**
 * HMAC-SHA256 request signer for the telegram-bots-gateway (todo 4).
 *
 ...
 * gateway guard fails open when no clients are registered (kol-system
 * mirror). Secrets and signatures are never logged here.
 */
@Injectable()
