 ...
 *
 * Mirrors apps/backend/src/shared/kernel/entity.ts. In this architecture,
 * AggregateRoot is used for entities that own a domain cluster. Pure entities
 * (without behavior) are rare in DDD.
 */
