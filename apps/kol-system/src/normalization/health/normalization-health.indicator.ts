...
/**
 * P21 hook point: normalization health indicator.
 *
 * Reports the normalization component status for the future composite
 ...
 */
@Injectable()
export class NormalizationHealthIndicator {
  public check(): ComponentHealth {
    return { component: 'normalization', status: 'up' };
  }
}
