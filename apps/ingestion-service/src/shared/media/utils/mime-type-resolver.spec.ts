...
describe('MimeTypeResolver', () => {
  describe('getExtensionFromMimeType', () => {
    it('should return correct extension for common image types', () => {
      expect(MimeTypeResolver.getExtensionFromMimeType('image/jpeg')).toBe('.jpg');
      expect(MimeTypeResolver.getExtensionFromMimeType('image/png')).toBe('.png');
      expect(MimeTypeResolver.getExtensionFromMimeType('image/gif')).toBe('.gif');
      expect(MimeTypeResolver.getExtensionFromMimeType('image/webp')).toBe('.webp');
    });

    it('should return correct extension for video types', () => {
      expect(MimeTypeResolver.getExtensionFromMimeType('video/mp4')).toBe('.mp4');
      expect(MimeTypeResolver.getExtensionFromMimeType('video/mpeg')).toBe('.mpeg');
      expect(MimeTypeResolver.getExtensionFromMimeType('video/webm')).toBe('.webm');
    });
    ...
    it('should return .bin for unknown MIME types', () => {
      expect(MimeTypeResolver.getExtensionFromMimeType('unknown/type')).toBe('.bin');
      expect(MimeTypeResolver.getExtensionFromMimeType('application/x-custom')).toBe('.bin');
    });

    it('should return .bin for empty or null MIME types', () => {
      expect(MimeTypeResolver.getExtensionFromMimeType('')).toBe('.bin');
      expect(MimeTypeResolver.getExtensionFromMimeType(null as any)).toBe('.bin');
    });
  });
  ...
  describe('getMimeTypeFromExtension', () => {
    it('should return correct MIME type for common extensions', () => {
      ...
      expect(MimeTypeResolver.getMimeTypeFromExtension('.jpg')).toBe('image/jpg');
      expect(MimeTypeResolver.getMimeTypeFromExtension('.png')).toBe('image/png');
      expect(MimeTypeResolver.getMimeTypeFromExtension('.mp4')).toBe('video/mp4');
    });
    ...
    it('should return octet-stream for unknown extensions', () => {
      expect(MimeTypeResolver.getMimeTypeFromExtension('.xyz')).toBe('application/octet-stream');
      expect(MimeTypeResolver.getMimeTypeFromExtension('.unknown')).toBe('application/octet-stream');
    });

    it('should return octet-stream for empty extension', () => {
      expect(MimeTypeResolver.getMimeTypeFromExtension('')).toBe('application/octet-stream');
    });
  });
  ...
  describe('getMimeTypeFromTelegramMedia', () => {
    it('should return image/jpeg for photo messages', () => {
      ...
      expect(MimeTypeResolver.getMimeTypeFromTelegramMedia(photoMedia)).toBe('image/jpeg');
    });
    ...
    it('should return document MIME type for documents', () => {
      ...
      expect(MimeTypeResolver.getMimeTypeFromTelegramMedia(docMedia)).toBe('video/mp4');
    });
    ...
    it('should return null for documents without MIME type', () => {
      ...
      expect(MimeTypeResolver.getMimeTypeFromTelegramMedia(docMedia)).toBeNull();
    });

    it('should return null for unknown media types', () => {
      const unknownMedia = { className: 'MessageMediaWebPage' };
      expect(MimeTypeResolver.getMimeTypeFromTelegramMedia(unknownMedia)).toBeNull();
    });

    it('should return null for null/undefined media', () => {
      expect(MimeTypeResolver.getMimeTypeFromTelegramMedia(null)).toBeNull();
      expect(MimeTypeResolver.getMimeTypeFromTelegramMedia(undefined)).toBeNull();
    });
  });
