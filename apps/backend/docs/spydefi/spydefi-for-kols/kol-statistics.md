> For the complete documentation index, see [llms.txt](https://docs.spydefi.org/spydefi-docs/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.spydefi.org/spydefi-docs/spydefi-for-kols/kol-statistics.md).
...
```
GET https://docs.spydefi.org/spydefi-docs/spydefi-for-kols/kol-statistics.md?ask=<question>
```
