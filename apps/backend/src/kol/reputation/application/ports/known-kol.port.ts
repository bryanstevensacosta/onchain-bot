 ...
 * `kol/reputation/infrastructure/known-kol/`).
 *
...
export abstract class KnownKolPort {
  public abstract getGoodScore(kolId: string): Promise<number | null>;
  public abstract isBad(kolId: string): Promise<boolean>;
}
