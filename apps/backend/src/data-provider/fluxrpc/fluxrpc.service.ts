/**
 * @deprecated Moved to apps/market-data/src/provider/infrastructure/fluxrpc/ (Tramo 3, todo 4, C-DATA-01).
 ...
 *
 * New location: apps/market-data/src/provider/infrastructure/fluxrpc/
 ...
 */
export * from '../../../../market-data/src/provider/infrastructure/fluxrpc/fluxrpc.service';
