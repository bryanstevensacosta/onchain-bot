/**
 * Canonical chain identifier (network-level).
 *
 * Promoted to `src/chain/identity/` from `shared/common/value-objects/chain-id.vo.ts`
 ...
 * detection result.
 *
 * IMPORTANT: This is now a **shared kernel contract** for the chain BC.
 * Changing the payload (adding a new chain id, changing validation rules)
 * is a breaking change for ALL importing BCs. Coordinate changes carefully.
 */
