...
class InMemoryRepo extends VipCallApprovalDecisionRepository {
...
/**
 * Test fake for SettingsService — only the three methods ApplyVipCallApprovalUseCase
...
describe('ApplyVipCallApprovalUseCase', () => {
  let blacklist: FakeBlacklist;
  let repo: InMemoryRepo;
  let publisher: InMemoryPublisher;
  let settings: FakeSettings;
  let useCase: ApplyVipCallApprovalUseCase;
  ...
  beforeEach(() => {
    ...
    useCase = new ApplyVipCallApprovalUseCase(
      blacklist,
      repo,
      publisher,
      settings as never,
