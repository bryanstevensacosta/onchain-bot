 ...
 *
 * Config defaults sourced from SettingsService (see ApplyVipCallApprovalUseCase).
 */
@Injectable()
export class VipCallScoreHandler {
  private readonly logger = new Logger(VipCallScoreHandler.name);

  public constructor(private readonly apply: ApplyVipCallApprovalUseCase) {}
