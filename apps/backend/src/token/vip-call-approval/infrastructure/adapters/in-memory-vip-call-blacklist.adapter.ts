 ...
 */
@Injectable()
export class InMemoryVipCallBlacklistAdapter extends VipCallBlacklistPort {
  private readonly logger = new Logger(InMemoryVipCallBlacklistAdapter.name);
  ...
  public constructor() {
    super();
    InMemoryVipCallBlacklistAdapter.HARDCODED.forEach((entry) => {
      this.known.set(
