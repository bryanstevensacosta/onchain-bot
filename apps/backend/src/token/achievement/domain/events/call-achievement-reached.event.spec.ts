...
describe('CallAchievementReachedEvent', () => {
  ...
  it('uses eventName achievement.call.reached', () => {
    const evt = new CallAchievementReachedEvent('solana:ABC', payload);
    expect(evt.eventName).toBe('achievement.call.reached');
  });
