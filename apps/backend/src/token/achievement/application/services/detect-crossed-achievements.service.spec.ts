import { DetectCrossedAchievementsService } from './detect-crossed-achievements.service';

describe('DetectCrossedAchievementsService', () => {
  const service = new DetectCrossedAchievementsService();
