import { InMemoryMilestoneThresholdRepository } from './in-memory-milestone-threshold.repository';

describe('InMemoryMilestoneThresholdRepository', () => {
  let repo: InMemoryMilestoneThresholdRepository;

  beforeEach(() => {
    repo = new InMemoryMilestoneThresholdRepository();
  });
