...
import { MilestoneThresholdRepository } from '../ports/milestone-threshold.repository';
...
export class EvaluateActiveCallsUseCase {
  ...
  constructor(
    ...
    private readonly notifiedRepo: NotifiedMilestoneRepository,
    private readonly detector: DetectCrossedMilestonesService,
    private readonly recordUseCase: RecordNotifiedMilestoneUseCase,
