...
- Per-app `CHANGELOG.md` (`apps/{backend,frontend,ingestion-service}/CHANGELOG.md`) — hand-written from conventional commits (automation removed 2026-09-11; see `RELEASE-FLOW.md`, forthcoming).
