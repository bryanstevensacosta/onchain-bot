...
import {
  ...
  FilterConfig,
} from 'discovery/filters/application/handlers/apply-filters.use-case';
...
import { ApplyFiltersInput } from 'discovery/filters/api/input/apply-filters.input';
import type { FilterDecisionView } from 'discovery/filters/application/mappers/filter-decision.mapper';
