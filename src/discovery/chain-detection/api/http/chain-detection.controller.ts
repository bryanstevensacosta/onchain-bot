...
import { DetectChainInput } from 'discovery/chain-detection/api/input/detect-chain.input';
import type { ChainDetectionResultView } from 'discovery/chain-detection/application/mappers/chain-detection-result.mapper';

@Controller('discovery/chain-detection')
