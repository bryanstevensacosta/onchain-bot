...
import { ExtractInput } from 'discovery/extraction/api/input/extract.input';
import type { ExtractionResultView } from 'discovery/extraction/application/mappers/extraction-result.mapper';
 ...
 */
@Controller('discovery/extraction')
