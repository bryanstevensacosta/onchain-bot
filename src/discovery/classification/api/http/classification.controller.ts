...
import { ClassifyTokenInput } from 'discovery/classification/api/input/classify-token.input';
import type { TokenClassificationView } from 'discovery/classification/application/mappers/token-classification.mapper';

@Controller('discovery/classification')
