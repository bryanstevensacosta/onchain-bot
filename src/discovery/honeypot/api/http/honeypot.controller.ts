...
import { AnalyzeHoneypotInput } from 'discovery/honeypot/api/input/analyze-honeypot.input';
import type { HoneypotAnalysisView } from 'discovery/honeypot/application/mappers/honeypot-analysis.mapper';

@Controller('discovery/honeypot')
