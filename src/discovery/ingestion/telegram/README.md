...
Forma parte de `src/discovery/ingestion/telegram` y se monta en la aplicación a través de `telegram-ingestion.module.ts:24`.
...
```
src/discovery/ingestion/telegram/
