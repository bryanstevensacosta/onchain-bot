...
import type { TelegramListenerPort } from 'discovery/ingestion/telegram/domain/ports/telegram-listener.port';
import type { AddChannelUseCase } from 'discovery/ingestion/telegram/application/handlers/add-channel.use-case';
import type { StartListeningUseCase } from 'discovery/ingestion/telegram/application/handlers/start-listening.use-case';
...
import type { CachedChannelMetadata } from 'discovery/ingestion/telegram/application/ports/resolved-channel-metadata.repository';
