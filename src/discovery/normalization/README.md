...
- `Map<string, CanonicalTokenCall>` con `MAX_ENTRIES = 5000` (`:16`) — **mayor** que los demás repos (500-1000) porque es el agregador central del pipeline discovery.
