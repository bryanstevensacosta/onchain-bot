...
import { ScoreTokenInput } from 'discovery/scoring/api/input/score-token.input';
import type { TokenScoreView } from 'discovery/scoring/application/mappers/token-score.mapper';

@Controller('discovery/scoring')
