...
import { AnalyzeHoneypotInput } from 'ca/honeypot/api/input/analyze-honeypot.input';
import type { HoneypotAnalysisView } from 'ca/honeypot/application/mappers/honeypot-analysis.mapper';

@Controller('ca/honeypot')
