...
import {
  ...
  FilterConfig,
} from 'ca/filters/application/handlers/apply-filters.use-case';
...
import { ApplyFiltersInput } from 'ca/filters/api/input/apply-filters.input';
import type { FilterDecisionView } from 'ca/filters/application/mappers/filter-decision.mapper';

@Controller('ca/filters')
