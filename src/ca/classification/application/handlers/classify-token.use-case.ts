...
import { RiskSignal } from 'ca/classification/domain/value-objects/risk-signal.vo';
import { TokenClassification } from 'ca/classification/domain/entities/token-classification.entity';
...
} from 'ca/classification/application/mappers/token-classification.mapper';
...
export class ClassifyTokenUseCase {
  ...
  public async execute(
    ...
    const { classification, signals } = this.classify(input);
