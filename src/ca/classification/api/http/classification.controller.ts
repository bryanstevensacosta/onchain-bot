...
import { ClassifyTokenInput } from 'ca/classification/api/input/classify-token.input';
import type { TokenClassificationView } from 'ca/classification/application/mappers/token-classification.mapper';

@Controller('ca/classification')
