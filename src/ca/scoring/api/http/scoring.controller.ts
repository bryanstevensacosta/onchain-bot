...
import { ScoreTokenInput } from 'ca/scoring/api/input/score-token.input';
import type { TokenScoreView } from 'ca/scoring/application/mappers/token-score.mapper';

@Controller('ca/scoring')
