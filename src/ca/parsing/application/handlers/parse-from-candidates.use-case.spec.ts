...
import {
  ParserPort,
  ParsedCallFields,
} from 'ca/parsing/domain/ports/parser.port';
...
import { TokenCall } from 'ca/parsing/domain/entities/token-call.entity';
...
describe('ParseFromCandidatesUseCase', () => {
  ...
  it('returns DomainError for invalid channelId', async () => {
    await expect(
      useCase.execute({
        channelId: '',
        messageId: 1,
