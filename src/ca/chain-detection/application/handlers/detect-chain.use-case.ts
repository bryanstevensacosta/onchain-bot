...
import { ChainDetectionResult } from 'ca/chain-detection/domain/entities/chain-detection-result.entity';
import { ChainDetectionScore } from 'ca/chain-detection/domain/value-objects/chain-detection-score.vo';
