...
import { DetectChainInput } from 'ca/chain-detection/api/input/detect-chain.input';
import type { ChainDetectionResultView } from 'ca/chain-detection/application/mappers/chain-detection-result.mapper';

@Controller('ca/chain-detection')
