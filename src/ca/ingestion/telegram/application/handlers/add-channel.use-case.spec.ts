...
import type { TelegramChannel } from 'ca/ingestion/telegram/domain/entities/telegram-channel.entity';
import type { ChannelId } from 'ca/ingestion/telegram/domain/value-objects/channel-id.vo';
