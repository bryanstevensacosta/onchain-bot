...
import { PublishCallInput } from 'ca/publishing/telegram/api/input/publish-call.input';
import type { PublishedCallView } from 'ca/publishing/telegram/application/mappers/published-call.mapper';

@Controller('ca/publishing/telegram')
